...
import { greet, isFromBellville, regCheck, countRegNumber, isWeekday, yearsAgo, allPaarl, countAllFromTown, transportFee, totalPhoneBill, fromWhere, findItemsOver20, findItemsOver, mostProfitableDepartment, mostProfitableDay } from '../app.js'
import { itemList, itemsOver20Answer, itemList2, findItemsAnswer, salesData, salesData2 } from '../data/data.js'
